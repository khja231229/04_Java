...
import edu.kh.poly.pack3.model.dto.BDHCalcultor;
import edu.kh.poly.pack3.model.dto.BDHCalcultor2;
...
//		Calculator cal = new BDHCalcultor();
		Calculator cal = new BDHCalcultor2();
		...
		System.out.println( cal.mod(4,3) );
		System.out.println("----------------------");
